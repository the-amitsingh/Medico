const products = [
  ...
  countInStock : 500,      category: "Women's Care"
    ...
    // ------- LabTests ---------\\
    {
        imgsrc: "https://i.postimg.cc/SxzwXmYz/Laboratoty.jpg",
        title: "Apollo Diagnostics",
        indication: "A test used to help figure out what disease or condition a person has based on their signs and symptoms. Diagnostic tests may also be used to help plan treatment, find out how well treatment is working, and make a prognosis.",
     
        sideEffects: "Body As A Whole : Headache, back pain, viral infection. Gastrointestinal : Nausea, vomiting, abdominal pain, indigestion, diarrhea. Musculoskeletal : Joint and muscle pain. Central Nervous System : Nervousness, depression. Respiratory : Nose inflammation, inflammation of the sinuses.urinary tract infection",
        price: 1000,
  
  countInStock : 500,      category: "LabTest"
    },
];
